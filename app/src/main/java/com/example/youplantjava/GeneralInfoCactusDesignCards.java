...
public class GeneralInfoCactusDesignCards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_info_cactus_design_cards);
    ...
    protected void onPause() {
        ...
        pageData.put("page_name", "GeneralInfoCactusDesignCards");
